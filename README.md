...
3. You will also need to download and install below 3 packages after you install either python or anaconda from the steps above
  ...
  - if you have chosen to install python 3.8 then run below commands in command prompt/terminal to install these packages
   ```
...
```
$ git clone https://github.com/PrathameshSonar/FAKE_NEWS_DETECTION.git
```
